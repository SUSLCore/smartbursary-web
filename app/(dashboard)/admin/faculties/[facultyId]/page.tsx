      ...
      <div className="relative flex flex-col gap-5 rounded-[1.75rem] border border-white/70 bg-white/80 p-6 shadow-sm backdrop-blur sm:flex-row sm:items-end sm:justify-between sm:p-8">
        <div className="max-w-2xl">
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-[#17365d] shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-[#27b8d2]/40 hover:shadow-md hover:shadow-[#27b8d2]/10"
          >
            <span aria-hidden="true">←</span>
            Back to faculties
          </button>

          <span className="mt-5 inline-flex items-center gap-2 rounded-full bg-[#27b8d2]/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.18em] text-[#17365d]">
        ...
        <div className="rounded-[1.5rem] border border-[#27b8d2]/20 bg-[#27b8d2]/10 px-4 py-3 text-sm text-[#17365d] shadow-sm">
          Departments loaded:{" "}
        ...
        <div className="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          {departments.map((department) => (
            <button
              ...
              className="group rounded-[1.25rem] border border-slate-200/80 bg-white p-5 text-left shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#27b8d2]/40 hover:shadow-lg hover:shadow-[#27b8d2]/10"
            >
